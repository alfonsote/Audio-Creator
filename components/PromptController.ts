...
export class PromptController extends LitElement {
  // FIX: This member cannot have an 'override' modifier because its containing class 'PromptController' does not extend another class.
  ...
  private dispatchPromptChange() {
    // FIX: Property 'dispatchEvent' does not exist on type 'PromptController'.
