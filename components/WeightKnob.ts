...
export class WeightKnob extends LitElement {
  // FIX: This member cannot have an 'override' modifier because its containing class 'WeightKnob' does not extend another class.
  ...
  private handlePointerMove(e: PointerEvent) {
    ...
    // FIX: Property 'dispatchEvent' does not exist on type 'WeightKnob'.
